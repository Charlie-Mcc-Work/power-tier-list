...
/** Check if adding an edge would create a cycle (DFS from inferior to superior) */
export function wouldCreateCycle(
  graph: AdjacencyList,
  superiorId: string,
  inferiorId: string,
): boolean {
  // If we add superiorId -> inferiorId, check if there's already a path from inferiorId to superiorId
