...
const KIND_LABELS: Record<string, { label: string; color: string }> = {
  ...
  statement: { label: 'Statement', color: 'text-amber-400 bg-amber-900/30 border-amber-700/50' },
...
export function EvidenceItem({ evidence, characters }: Props) {
  ...
  return (
    <div className="p-3 bg-[#1e1e1e] rounded-lg border border-gray-700 space-y-2">
